...
import com.example.money.api.models.Categoria_;
import com.example.money.api.models.Lancamento;
import com.example.money.api.models.Lancamento_;
import com.example.money.api.models.Pessoa_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	public Page<ResumoLancamento> resumir(LancamentoFilter lancamentoFilter, Pageable pageable) {
		CriteriaBuilder builder = this.mananger.getCriteriaBuilder();
		...
		TypedQuery<ResumoLancamento> query = this.mananger.createQuery(criteria);
	...
	public Page<Lancamento> filtrar(LancamentoFilter lancamentoFilter, Pageable pageable) {
		...
		TypedQuery<Lancamento> query = this.mananger.createQuery(criteria);
	...
	private Long total(LancamentoFilter lancamentoFilter) {
		...
		return this.mananger.createQuery(criteria).getSingleResult();
	}
